...
public class Product extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4819848512642959650L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Product\",\"namespace\":\"com.model\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"id\",\"type\":[\"int\",\"null\"]},{\"name\":\"company\",\"type\":[\"string\",\"null\"]}]}");
   ...
   */
  public static com.model.Product.Builder newBuilder() {
    return new com.model.Product.Builder();
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static com.model.Product.Builder newBuilder(com.model.Product.Builder other) {
    if (other == null) {
      return new com.model.Product.Builder();
    } else {
      return new com.model.Product.Builder(other);
    }
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static com.model.Product.Builder newBuilder(com.model.Product other) {
    if (other == null) {
      return new com.model.Product.Builder();
    } else {
      return new com.model.Product.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Product>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.model.Product.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.model.Product other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.model.Product.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.model.Product.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.model.Product.Builder setId(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.model.Product.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.model.Product.Builder setCompany(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.model.Product.Builder clearCompany() {
      company = null;
